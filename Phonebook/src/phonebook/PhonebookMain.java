...
import java.util.*;
	...
	public static void main(String[] args) {
		Person p1 = new Person("Richard", "McGoo", "Cheese", 183432323L);
		p1.addAddress(123, "Mockingbird Lane", "Atlanta", "GA", "36966" );
...
//		System.out.println("Enter the number of a person that you'd like to find below: ");
//		Long phone = input.nextLong();
//		directory.printDirectoryArray(directory.deletePhone(phone));{
//		}
...
//	System.out.println("Enter the number of a person that you'd like to find below: ");
//	Long phone = input.nextLong();
//	directory.printDirectoryArray(directory.updatePhone(phone));{
//	}
	System.out.println("This function DOES NOT WORK");
	try {
		try (//Menu display and establish Scanner
